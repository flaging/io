...
[ALog](https://github.com/duxins/alog): 录音转写及总结工具

[minimal-llm-ui](https://github.com/richawo/minimal-llm-ui): ollama UI

[notesGPT](https://github.com/Nutlope/notesGPT): 使用语音输入并使用GPT总结的记录应用

[农村自建房图纸](https://m.okjike.com/originalPosts/65c851a212ed2fda6824cbdf?s=eyJ1IjoiNTkxYTVjZjNjZDIwYTYwMDEzZDZmMGUxIiwiZCI6Mn0%3D): [北京样式](https://ghzrzyw.beijing.gov.cn/biaozhunguanli/bzgj/zdxtj/), [上海样式](https://zjw.sh.gov.cn/zt7/index.html), 可以到自家县政府网站中寻找一下

[WeChatMsg](https://github.com/LC044/WeChatMsg): 微信聊天记录导出成HTML