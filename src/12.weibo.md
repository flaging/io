...
#### [linkedin出品的SRE入门教程。地址：linkedin.github.io/school-of @蚁工厂](https://weibo.com/2194035935/NwcrU4G6Q)

Note: linkedin出品的SRE入门教程。地址：linkedin.github.io/school-of-sre/分Level 101和102两部分。101包括linux基础、Git、linux网络、python、数据库（关系数据库、nosql和大数据的基础介绍）、系统设计、监控度量、安全相关的内容。102包括linux中高级（包括容器技术docker、k8s）、网络、系统设计、排查故障和性能改进、持续集成等内容。回复:回复:给原博过两岁生日咋又突然转这个了
...
#### [【Optimum-NVIDIA：提供NVIDIA平台和Hugging Face相结合的最佳推理性能， @#开源#](https://weibo.com/1402400261/NvUP1Ct12)

Note: 【Optimum-NVIDIA：提供NVIDIA平台和Hugging Face相结合的最佳推理性能，通过在现有Transformers代码中修改一行代码，可以以每秒1,200个token的速度运行LLaMA 2（比framework快28倍）】'Optimum-NVIDIA' by Hugging Face GitHub: github.com/huggingface/optimum-nvidia   

Picture: [5396ee05ly8hkkeclk2aaj21dc0n842f.jpg](https://weibo.cn//mblog/pic/NvUP1Ct12?rl=1)

Github: [github.com/huggingface/optimum-nvidia](https://github.com/huggingface/optimum-nvidia)

#### [【MLX：苹果芯片的深度计算框架，旨在为机器学习研究人员提供简单易用、高效训练和部署模型的工具，具有 @爱可可-爱生活](https://weibo.com/1402400261/NvUNWvHfP)

Note: 【MLX：苹果芯片的深度计算框架，旨在为机器学习研究人员提供简单易用、高效训练和部署模型的工具，具有与NumPy相似的Python API和与之相似的C++ API。MLX支持自动微分、自动向量化和计算图优化等可组合的函数变换，具有延迟计算和动态图构建的特性，可在CPU和GPU上运行。与其他框架不同，MLX采用统一内存模型，数组存储在共享内存中，可以在不移动数据的情况下在不同设备上执行操作。MLX的设计受到NumPy、PyTorch、Jax和ArrayFire等框架的启发】’MLX - MLX: An array framework for Apple silicon' ml-explore GitHub: github.com/ml-explore/mlx  好家伙，这可太带劲了//:项目示例：github.com/ml-explore/mlx-examples

Picture: [5396ee05ly8hkke2223srj20u00wh44a.jpg](https://weibo.cn//mblog/pic/NvULqA183?rl=1)

Github: [github.com/ml-explore/mlx](https://github.com/ml-explore/mlx)

Github: [github.com/ml-explore/mlx-examples](https://github.com/ml-explore/mlx-examples)

#### [【MLX：苹果芯片的深度计算框架，旨在为机器学习研究人员提供简单易用、高效训练和部署模型的工具，具有 @#开源#](https://weibo.com/1402400261/NvULqA183)

Note: 【MLX：苹果芯片的深度计算框架，旨在为机器学习研究人员提供简单易用、高效训练和部署模型的工具，具有与NumPy相似的Python API和与之相似的C++ API。MLX支持自动微分、自动向量化和计算图优化等可组合的函数变换，具有延迟计算和动态图构建的特性，可在CPU和GPU上运行。与其他框架不同，MLX采用统一内存模型，数组存储在共享内存中，可以在不移动数据的情况下在不同设备上执行操作。MLX的设计受到NumPy、PyTorch、Jax和ArrayFire等框架的启发】’MLX - MLX: An array framework for Apple silicon' ml-explore GitHub: github.com/ml-explore/mlx  苹果在这方面折腾的再欢，大客户还是会弄一堆 Linux 机器和 NVIDIA 显卡在机房里，因为这样更便宜。

Picture: [5396ee05ly8hkke2223srj20u00wh44a.jpg](https://weibo.cn//mblog/pic/NvULqA183?rl=1)

Github: [github.com/ml-explore/mlx](https://github.com/ml-explore/mlx)

#### [苹果正式加入开源AI大家庭，推出了专为M芯片设计、深度优化的机器学习加速框架，项目已开源发布：git @林亦LYi](https://weibo.com/2194035935/NvRDhvK2r)

Note: 苹果正式加入开源AI大家庭，推出了专为M芯片设计、深度优化的机器学习加速框架，项目已开源发布：github.com/ml-explore/mlx不过苹果硬件生态相对封闭，一个被限定在苹果生态里的开源项目未来会如何发展？ 

Picture: [00729tAsgy1hkk0jfu7foj30la0la3zi.jpg](https://weibo.cn//mblog/pic/NvRCPy4jr?rl=1)

Github: [github.com/ml-explore/mlx](https://github.com/ml-explore/mlx)

#### [《TCP/IP网络编程》学习笔记Github地址：github.com/riba2534/TCP-I @蚁工厂](https://weibo.com/2194035935/NvR4eclYi)

Note: 《TCP/IP网络编程》学习笔记Github地址：github.com/riba2534/TCP-IP-NetworkNote此仓库是作者riba2534的《TCP/IP网络编程》学习笔记及具体代码实现，代码部分请参考本仓库对应章节文件夹下的代码。 

Picture: [82c654dfly1gx3vg53t1hj20h819l78f.jpg](https://weibo.cn//mblog/pic/L4L67mT1T?rl=1)

Github: [github.com/riba2534/TCP-IP-NetworkNote](https://github.com/riba2534/TCP-IP-NetworkNote)
...
#### [技术博文《从零开始写RISC-V处理器》对应的开源项目为：tinyriscv 地址：github.c @蚁工厂](https://weibo.com/2194035935/NuZBvfqUE)
...
#### [Modern C++ Programming Course 现代C++编程课程（C++11/14/1 @转发[205]](https://weibo.com/2194035935/NuLK3igiP)

Note: Modern C++ Programming Course 现代C++编程课程（C++11/14/17/20）地址：github.com/federico-busato/Modern-CPP-Programming该开放式课程面向那些已经熟悉 C 和面向对象编程并达到 C++ 编程熟练程度的人员。本课程涵盖 C++ 编程基础知识，并继续介绍高级 C++ 语义和概念。 Basic Concepts。

Picture: [82c654dfly1hkbol75d6bj20tz1fs1gy.jpg](https://weibo.cn//mblog/pic/NuLK3igiP?rl=1)

Github: [github.com/federico-busato/Modern-CPP-Programming](https://github.com/federico-busato/Modern-CPP-Programming)

#### [电子书《A Complete Guide to Standard C++ Algorithms》标准 @蚁工厂](https://weibo.com/2194035935/NuLcofLw6)

Note: 电子书《A Complete Guide to Standard C++ Algorithms》标准 C++ 算法的完整指南地址：github.com/HappyCerberus/book-cpp-algorithms此存储库包含“标准 C++ 算法的完整指南”一书的 LaTeX 源代码和 C++ 代码示例 噫应该抽查囤印象笔记的，有多少学完了帖子内容反正我没学
...
#### [从零开始写一个虚拟机。文章介绍如何用 400 行左右的 C 代码实现一个虚拟机，该虚拟机能够运行标准 @蚁工厂](https://weibo.com/1715118170/NuPEP2C1G)
...
#### [电子书《Understanding Deep Learning》理解深度学习地址：udlbook.g @转发[259]](https://weibo.com/2194035935/NusQqqec1)
...
#### [【汇集了成为高级软件工程师所需要的各种资源】'Path to Senior Engineer han @#开源#](https://weibo.com/1402400261/NulcMrleV)

Note: 【汇集了成为高级软件工程师所需要的各种资源】'Path to Senior Engineer handbook - All the resources you need to get to Senior Engineer and beyond' Jordan Cutler GitHub: github.com/jordan-cutler/path-to-senior-engineer-handbook  

Picture: [5396ee05ly8hk8fffe5rfj212m0q0tbj.jpg](https://weibo.cn//mblog/pic/NulcMrleV?rl=1)

Github: [github.com/jordan-cutler/path-to-senior-engineer-handbook](https://github.com/jordan-cutler/path-to-senior-engineer-handbook)
...
#### [《分布式系统模式》中文版Github地址：github.com/dreamhead/patterns @蚁工厂](https://weibo.com/2194035935/NtTFqaLA6)
...
#### [推荐两本性能调优相关书。1、Is Parallel Programming Hard, And, I @黄岩gg](https://weibo.com/2194035935/NtMjactuZ)

Note: 推荐两本性能调优相关书。1、Is Parallel Programming Hard, And, If So, What Can You Do About It?这本书应该是RCU的发明人写的。书里对Linux内核用到的各种跟性能相关的机制，讲解非常清楚。下面是下载地址。https:\\mirrors.edge.kernel.org/pub/linux/kernel/people/paulmck/perfbook/perfbook.html下面是这本书的tex源码的下载地址。https:\\github.com/paulmckrcu/perfbook2、Performance analysis and tuning on modern CPUs这本书里面讲了现代乱序执行的超标量CPU的基本架构原理，以及怎么在Intel CPU上利用各种工具来做性能调优。https:\\faculty.cs.niu.edu/~winans/notes/patmc.pdf注意：上面的URL地址，需要反斜杠换成正斜杠。牛逼//:转发微博
...
#### [X 上的 Nathan Lambert 对 OpenAI 的 Q* RLHF（人类反馈强化学习）做了 @网页链接](https://weibo.com/1727858283/NtZ5Da2K0)

Note: X 上的 Nathan Lambert 对 OpenAI 的 Q* RLHF（人类反馈强化学习）做了科普，马斯克也在下面有互动。Q*（Q-star）其实包含两部分：1. Q Learning（一种强化学习算法）2. A Star（一种搜索算法）。但解释的还是偏专业，将原文翻译下：关于 OpenAI 正在开发的 Q* RLHF 的揭秘时间首先，让我们看看路透社文章中的一些有趣描述：“资深高管 Mira Murati 在周三对员工表示，一封关于 AI 突破性进展 Q*（读作 Q-Star）的信件促使董事会采取了行动。”+“得益于强大的计算资源，这个新模型能解决一些数学问题……虽然目前只能解决小学生级别的数学问题，但这样的成绩让研究人员对 Q* 的未来充满期待。”现在，请准备好：OpenAI 的新技术 Q*（Q-star）融合了两个关键元素：Q Learning（一种强化学习算法）和 A Star（一种搜索算法）。1. Q Learning 非常关键，它是第一个被广泛认可的强化学习算法，至今仍被广泛应用。在这里，Token 或词汇被视为状态，而某些回应则被视为行动。2. A Star 是一种以其在搜索过程中保存结果于内存而著称的图搜索算法。文章中提到：“得益于强大的计算资源，新模型能解决一些数学问题”，这意味着在新的 RLHF 训练中需要存储大量数据。搜索对于训练中的多轮优化至关重要。基本上，我认为是将 A* 公式应用于 Q 值，以实现多轮推理。为什么这种方法可能非常有效但又难以实现呢？* 多轮优化意味着需要更多的模型前向传递和梯度计算* 解决复杂数学问题需要这种方法* 实际上，这可能更接近于 RLAIF我关注的两个研究方向是：奖励增强解码：这是一种使用单向奖励模型进行高效控制文本生成的方法。改进 PPO 的新策略：通过值引导的蒙特卡洛树搜索解码进行优化。twitter.com/natolambert/status/1727476436838265324Unidirectional reward model is the key个人感觉 如果真是这两个算法的融合 那提”意识”就有点可笑了q-learning和a*还是算了吧转发微博图片评论 回复:都是炒作 我觉得sam也是故意不说明白q-learning和a*还是算了吧这是不是烟雾弹回复:不管是什么算法，往“意识”上靠都很可笑不过技术圈不能要求有啥哲学造诣再说赚钱不寒碜回复:确实回复:Uni不是un朋友找到的论文，21年发的，标题时间看起来都对得上 个人感觉 如果真是这两个算法的融合 那提”意识”就有点可笑了
...
#### [《可能是让你受益匪浅的英语进阶指南 》在这份指南里，作者会尽可能地综合我主观的看法与一定的科学依据， @蚁工厂](https://weibo.com/1888981347/Nuao9bTYS)

Note: 《可能是让你受益匪浅的英语进阶指南 》在这份指南里，作者会尽可能地综合我主观的看法与一定的科学依据，为大家提供一份详尽的英语进阶指南，真心希望本指南能给你带来一点小小的帮助。阅读地址：byoungd.gitbook.io/english-level-up-tips/之前发过这个，又看到了再发一次吧。 
...
#### [KuiperInfer (自制深度学习推理框架)地址：github.com/zjhellofss/K @转发[140]](https://weibo.com/2194035935/Nt73v0A1t)

Note: KuiperInfer (自制深度学习推理框架)地址：github.com/zjhellofss/KuiperInfer带你从零实现一个高性能的深度学习推理库，支持Unet、Yolov5、Resnet等模型的推理。跟随本项目，从零开始自制深度学习推理框架，你将有以下收获：----学习一个深度学习框架背后的知识，掌握现代C++项目的写法，调试技巧和工程经验；----如何设计、编写一个计算图；----实现常见的算子，卷积算子、池化算子、全连接算子等；----在3的基础上，学会常见的优化手段加速算子的执行；----最后你将获得一个属于自己的推理框架，可以推理resnet, unet, yolov5, mobilenet等模型，对面试和知识进阶大有裨益。🐴Repost

Picture: [82c654dfly1hjz39335l2j20sx0oath0.jpg](https://weibo.cn//mblog/pic/Nt73v0A1t?rl=1)
...
#### [《你管这破玩意叫操作系统源码？ — 像小说一样品读 Linux 0.11 核心代码》Github地址 @蚁工厂](https://weibo.com/2194035935/Nt1ib7dFb)

Note: 《你管这破玩意叫操作系统源码？ — 像小说一样品读 Linux 0.11 核心代码》Github地址：github.com/sunym1993/flash-linux0.11-talk目前只更新了两篇。里面还有个子项目《Intel手册翻译计划》，翻译Intel® 64 and IA-32 ArchitecturesSoftware Developer’s Manual 出书了，折后卖79元
...
#### [字跳的核心技术推荐系统要开源了嘛，现在已经在github上开了个坑，但还没有内容地址：github. @蚁工厂](https://weibo.com/2194035935/Nt0awahgZ)

Note: 字跳的核心技术推荐系统要开源了嘛，现在已经在github上开了个坑，但还没有内容地址：github.com/bytedance/monolith 
...
#### [用C写一个Hash表地址：github.com/jamesroutley/write-a-hash- @转发[82]](https://weibo.com/2194035935/NsI2qmuzD)

Note: 用C写一个Hash表地址：github.com/jamesroutley/write-a-hash-table哈希表是最实用的数据结构之一，因为它们具有快速、可扩展的插入、搜索和删除功能，适用于许多计算机科学问题。在这个教程中，我们将使用 C 语言实现一个开放地址、双散列哈希表。通过学习这个教程，您将获得：----了解一个基本数据结构在底层是如何工作的----更深入地了解何时使用哈希表，何时不使用以及它们可能出现的问题直接用uthash用perl把，原生的数据结构C写hash之前翻译过一篇「在 C 语言中实现简单的哈希表」，算是个精简版，文章链接🔗：
...
#### [系统设计类文章收集地址：github.com/ashishps1/awesome-system-de @#科技风向标#](https://weibo.com/2194035935/NsDJp52BJ)

Note: 系统设计类文章收集地址：github.com/ashishps1/awesome-system-design-resources该存储库包含系统设计资源，在准备面试和学习分布式系统时非常有用  

Picture: [82c654dfly1hjvhscah0jj20mr187n9b.jpg](https://weibo.cn//mblog/pic/NsDJp52BJ?rl=1)

Github: [github.com/ashishps1/awesome-system-design-resources](https://github.com/ashishps1/awesome-system-design-resources)
...
#### [我的开源项目预发布了，基于C++开发，面向边缘和端，训推一体的大模型开发框架。github.com/ @Teaonly计算音乐](https://weibo.com/2194035935/Nswln5QMr)

Note: 我的开源项目预发布了，基于C++开发，面向边缘和端，训推一体的大模型开发框架。github.com/viitrix/vt-transformer 万能的朋友圈求国产硬件合作，我们可以做国产硬件适配自愿者！注意，这不是造轮子，边端的需求，国产硬件的环境，需要一个新的大模型开发框架。 //://:转发微博

Picture: [6e6bcb35gy1hjujrzk0dcj20v20jo7h1.jpg](https://weibo.cn//mblog/pic/Nsw1Yl1Td?rl=1)

Github: [github.com/viitrix/vt-transformer](https://github.com/viitrix/vt-transformer)

#### [这个开源项目英文名字叫做 Deep Learning System 或者 AI System(AIS @转发[143]](https://weibo.com/2194035935/NsvIV5azM)

Note: 这个开源项目英文名字叫做 Deep Learning System 或者 AI System(AISys)，中文名字叫做 深度学习系统 或者 AI系统。地址：github.com/chenzomi12/DeepLearningSystem本开源项目主要是跟大家一起探讨和学习人工智能、深度学习的系统设计，而整个系统是围绕着 ZOMI 在工作当中所积累、梳理、构建 AI 系统全栈的内容。希望跟所有关注 AI 开源项目的好朋友一起探讨研究，共同促进学习讨论。

Picture: [82c654dfly1hjuepakq2ij21is10x1ec.jpg](https://weibo.cn//mblog/pic/NsvIV5azM?rl=1)
...
#### [使用 Fish shell 和 Tmux 的终极 shell 设置（第 1 部分）【My ultim @网路冷眼](https://weibo.com/1715118170/Nsle9yV3e)
...
#### [北大编译实践在线文档地址：pku-minic.github.io/online-doc在本课程中,  @蚁工厂](https://weibo.com/2194035935/NrKTZhJQ7)

Note: 北大编译实践在线文档地址：pku-minic.github.io/online-doc在本课程中, 你将实现一个可将 SysY 语言编译到 RISC-V (读作 “risk-five”) 汇编的编译器. SysY 语言是一种精简版的 C 语言, RISC-V 则是一种新兴且热门的指令系统 (ISA). 而你的编译器, 则需要在这两者之间建立联系. 
...
#### [【inshellisense：在shell命令行中自动完成的工具，功能类似IDE，可大大提升在She @#开源#](https://weibo.com/1402400261/NrEvlnDVR)

Note: 【inshellisense：在shell命令行中自动完成的工具，功能类似IDE，可大大提升在Shell命令行下的开发效率，支持Windows, Linux和MacOS三大平台，支持bash, zsh, fish, pwsh和powershell五种 Shell】’inshellisense - IDE style command line auto complete' Microsoft GitHub: github.com/microsoft/inshellisense 

Github: [github.com/microsoft/inshellisense](https://github.com/microsoft/inshellisense)
...
#### [BlueLM 是由 vivo AI 全球研究院自主研发的大规模预训练语言模型，本次发布包含 7B 基 @vivo开发者](https://weibo.com/2194035935/NrkmIj6gG)

Note: BlueLM 是由 vivo AI 全球研究院自主研发的大规模预训练语言模型，本次发布包含 7B 基础 (base) 模型和 7B 对话 (chat) 模型。 地址：github.com/vivo-ai-lab/BlueLM评测结果如图。 

Picture: [82c654dfly1hjlijzx37yj21hl0lzgvh.jpg](https://weibo.cn//mblog/pic/NrkmIj6gG?rl=1)
...
#### [【全球最大的中文非虚构图书馆藏，仅限LLM公司使用】- Anna's Archive获取了包含750 @网页链接](https://weibo.com/1402400261/NrgSjyrbw)
...
#### [【tailspin：开源日志文件高亮插件，可以用于实时观看或追踪任何格式的日志文件,无需额外配置，内 @#开源#](https://weibo.com/1402400261/NqQLf9zTe)

Note: 【tailspin：开源日志文件高亮插件，可以用于实时观看或追踪任何格式的日志文件,无需额外配置，内置了颜色语法高亮功能,可以高亮 dates、numbers、IP addresses、URLs等内容】’tailspin - A log file highlighter' Ben Sadeh GitHub: github.com/bensadeh/tailspin  

Picture: [5396ee05ly8hjhvuvt46uj21a20u010q.jpg](https://weibo.cn//mblog/pic/NqQLf9zTe?rl=1)

Github: [github.com/bensadeh/tailspin](https://github.com/bensadeh/tailspin)

#### [【DeepSeek Coder：开源代码语言模型，包含了英语和中文两种语言版本的代码生成模型。模型经 @#开源#](https://weibo.com/1402400261/NqQIAAfKs)

Note: 【DeepSeek Coder：开源代码语言模型，包含了英语和中文两种语言版本的代码生成模型。模型经过大规模训练，训练数据中87%为代码数据，13%为自然语言数据。模型大小提供1B、5.7B、6.7B、33B等多个版本，满足不同需求。模型在人工评估、多语言程序、MBPP、DS-1000等多个编程基准上均表现出色，在项目级代码补全、代码插入等任务有很好的效果】'DeepSeek Coder: Let the Code Write Itself' DeepSeek GitHub: github.com/deepseek-ai/DeepSeek-Coder  看看开源代码助手

Picture: [5396ee05ly8hjhvm1eszxj20u00xatcq.jpg](https://weibo.cn//mblog/pic/NqQIAAfKs?rl=1)

Github: [github.com/deepseek-ai/DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
...
#### [#AI开源项目推荐：intel-extension-for-transformersIntel 官方 @网页链接](https://weibo.com/1727858283/NqMXkBUXM)

Note: #AI开源项目推荐：intel-extension-for-transformersIntel 官方出的针对Transformer的扩展，与 GGML 兼容，但性能比 llama.cpp 高出 1.5 倍！并且他们发布了相关论文：《Efficient LLM Inference on CPUs》论文摘要：大语言模型（LLMs）已经在广泛的任务中展示出了令人瞩目的表现和巨大的发展潜力。然而，由于这些模型的参数量异常庞大，使得它们的部署变得相当具有挑战性，这不仅需要有足够大的内存空间，还需要有高速的内存传输带宽。在这篇文章中，我们提出了一种高效的方法，可以使得大语言模型的部署变得更为高效。我们支持自动化的仅限权重的 INT4 量化流程，并为此设计了一个特殊的、经过高度优化的大语言模型运行时环境，从而加速了在 CPU 上进行大语言模型推理的过程。我们的方法在多个流行的大语言模型，包括 Llama2、Llama 和 GPT-NeoX 上都展示出了广泛的适用性，并且在 CPU 上实现了极高的推理效率。相关代码已经开源，可在以下链接获取：github.com/intel/intel-extension-for-transformers论文链接：中文翻译： 
...
#### [【HertzBeat：易用友好的开源实时监控告警系统，无需Agent，高性能集群，强大自定义监控能力 @#开源#](https://weibo.com/1402400261/NqhTuaeZL)

Note: 【HertzBeat：易用友好的开源实时监控告警系统，无需Agent，高性能集群，强大自定义监控能力】'HertzBeat - An open source, real-time monitoring system with custom-monitoring, high performance cluster and agentless. Support monitoring web, database, os, middleware, cloudnative, network and more.' dromara GitHub: github.com/dromara/hertzbeat 图2这种图是怎么做的？🤔

Picture: [5396ee05ly8hjdlxwgiljj21k90u0afy.jpg](https://weibo.cn//mblog/pic/NqhTuaeZL?rl=1)
...
#### [【Smallchat：编写聊天服务器的极简编程示例，用C语言编写，共有约200行代码，其初衷是为前端 @#开源#](https://weibo.com/1402400261/Nq6Z6q86C)

Note: 【Smallchat：编写聊天服务器的极简编程示例，用C语言编写，共有约200行代码，其初衷是为前端开发人员提供一个理解系统编程的经验，特别是关于IRC服务器的构建】’Smallchat - A minimal programming example for a chat server' Salvatore Sanfilippo GitHub: github.com/antirez/smallchat  

Picture: [5396ee05ly8hjc9m85rarj219q0tw10x.jpg](https://weibo.cn//mblog/pic/Nq6Z6q86C?rl=1)

Github: [github.com/antirez/smallchat](https://github.com/antirez/smallchat)
...
#### [【ChatGLM3：具有更强大的基础模型，在语义、数学、推理、代码、知识等不同角度的数据集上表现出强 @#开源#](https://weibo.com/1402400261/NpWPgFQ3x)

Note: 【ChatGLM3：具有更强大的基础模型，在语义、数学、推理、代码、知识等不同角度的数据集上表现出强大性能】'ChatGLM3 - ChatGLM3 series: Open Bilingual Chat LLMs | 开源双语对话语言模型' THUDM GitHub: github.com/THUDM/ChatGLM3   Mark  

Picture: [5396ee05ly8hjb0xnzm9sj216x0u0dj3.jpg](https://weibo.cn//mblog/pic/NpWPgFQ3x?rl=1)

Github: [github.com/THUDM/ChatGLM3](https://github.com/THUDM/ChatGLM3)
...
#### [《计算机程序的结构和解释》公开课 翻译项目地址：github.com/DeathKing/Learn @蚁工厂](https://weibo.com/2194035935/NpUmmlgIP)

Note: 《计算机程序的结构和解释》公开课 翻译项目地址：github.com/DeathKing/Learning-SICP《计算机程序的构造和解释》系列公开课，视频是两位作者（Harold Abelson、Gerald Jay Sussman）在1986年7月给Hewlett-Packard公司员工培训时的录像。这门课程只提供了英文字幕，本项目旨在将这些英文字幕翻译为中文，方便广大的Scheme/Lisp学习者。
...
#### [系统重构与迁移指南 电子书Phodal 手把手教你分析、评估现有系统、制定重构策略、探索可行重构方案 @蚁工厂](https://weibo.com/2194035935/NpMaJ9Ubc)

Note: 系统重构与迁移指南 电子书Phodal 手把手教你分析、评估现有系统、制定重构策略、探索可行重构方案、搭建测试防护网、进行系统架构重构、服务架构重构、模块重构、代码重构、数据库重构、重构后的架构守护地址：migration.ink 
...
#### [Zero123++: 一个扩散模型，只需提供一张图，就可以生成这张图的多个视角地址：github.c @转发[66]](https://weibo.com/2194035935/NpKvygIwY)

Note: Zero123++: 一个扩散模型，只需提供一张图，就可以生成这张图的多个视角地址：github.com/SUDO-AI-3D/zero123plus如图1给定上面的大图，下面的小图都是生成的  

Picture: [82c654dfly1hj9ijuh5c7j21731iz4he.jpg](https://weibo.cn//mblog/pic/NpKvygIwY?rl=1)

Github: [github.com/SUDO-AI-3D/zero123plus](https://github.com/SUDO-AI-3D/zero123plus)

#### [Raft博士论文的中文翻译Github地址：github.com/LebronAl/raft-the @蚁工厂](https://weibo.com/2194035935/NpFqilURS)
...
#### [电子书《THE STARTUP CTO'S HANDBOOK》初创公司CTO手册高--绩效工程团队的 @转发[97]](https://weibo.com/2194035935/Np0ju1yE0)

Note: 电子书《THE STARTUP CTO'S HANDBOOK》初创公司CTO手册高--绩效工程团队的基本技能和最佳实践地址：github.com/ZachGoldberg/Startup-CTO-Handbook内容主要是技术团队管理和技术架构选择相关 

Picture: [82c654dfly1hj3umgmnpdj20tu1if1ee.jpg](https://weibo.cn//mblog/pic/Np0ju1yE0?rl=1)

Github: [github.com/ZachGoldberg/Startup-CTO-Handbook](https://github.com/ZachGoldberg/Startup-CTO-Handbook)
...
#### [【CPU上运行的快速stable diffusion，Core i7-12700上生成一张512x5 @#开源#](https://weibo.com/1402400261/Np3se6t9P)

Note: 【CPU上运行的快速stable diffusion，Core i7-12700上生成一张512x512图片只要21秒】’Fast stable diffusion CPU' Rupesh Sreeraman GitHub: github.com/rupeshs/fastsdcpu   最好能不用显卡直接运行。 速度现在不是最关键的  你好，你感兴趣的“开源”已开通了超话社区～ 超话社区是微博旗下兴趣互动社区，快来与志同道合的小伙伴们一起交流互动吧！ 戳我进入>> 

Picture: [5396ee05ly8hj48gq62h6j20p30e8abu.jpg](https://weibo.cn//mblog/pic/Np3se6t9P?rl=1)

Github: [github.com/rupeshs/fastsdcpu](https://github.com/rupeshs/fastsdcpu)

#### [【免费书《初创公司CTO手册》，旨在为技术团队领导力提供指导，内容涵盖业务流程、人员管理、招聘面试、 @#开源#](https://weibo.com/1402400261/Np3r8rlGU)

Note: 【免费书《初创公司CTO手册》，旨在为技术团队领导力提供指导，内容涵盖业务流程、人员管理、招聘面试、入职培训、绩效管理、团队构成、领导责任等多个方面】’The Book - The Startup CTO's Handbook, a book covering leadership, management and technical topics for leaders of software engineering teams' Zach Goldberg GitHub: github.com/ZachGoldberg/Startup-CTO-Handbook 感谢您分享  感谢您分享还有这类手册呢...

Picture: [5396ee05ly8hj487vbmskj21eg0ro7a9.jpg](https://weibo.cn//mblog/pic/Np3r8rlGU?rl=1)
...
#### [【CodeShell VSCode Extension：基于CodeShell大模型开发的支持Vis @#开源#](https://weibo.com/1402400261/NoSvq3Hhb)

Note: 【CodeShell VSCode Extension：基于CodeShell大模型开发的支持Visual Studio Code的智能编码助手插件，支持python、java、c++/c、javascript、go等多种编程语言，为开发者提供代码补全、代码解释、代码优化、注释生成、对话问答等功能，旨在通过智能化的方式帮助开发者提高编程效率】'CodeShell VSCode Extension - An intelligent coding assistant plugin for Visual Studio Code, developed based on CodeShell' WisdomShell GitHub: github.com/WisdomShell/codeshell-vscode  

Picture: [5396ee05ly8hj2w5d2cpoj20x50lc433.jpg](https://weibo.cn//mblog/pic/NoSvq3Hhb?rl=1)

Github: [github.com/WisdomShell/codeshell-vscode](https://github.com/WisdomShell/codeshell-vscode)
...
#### [人手一个编程助手！北大最强代码大模型CodeShell-7B开源，性能霸榜，IDE插件全开源继 Co @PromptEngineer](https://weibo.com/2194035935/NoI3bgShU)

Note: 人手一个编程助手！北大最强代码大模型CodeShell-7B开源，性能霸榜，IDE插件全开源继 CodeLlama 开源之后，北大等机构正式开源了性能更强的代码基座大模型 CodeShell-7B 和代码助手 CodeShell-Chat。不仅如此，团队还把方便易用的 IDE 插件也开源了！今天，北京大学软件工程国家工程研究中心知识计算实验室联合四川天府银行 AI 实验室，正式开源 70 亿参数的代码大模型 CodeShell，成为同等规模最强代码基座。与此同时，团队将软件开发代码助手的完整解决方案全部开源，人手一个本地化轻量化的智能代码助手的时代已经来临！CodeShell 代码：github.com/WisdomShell/codeshellCodeShell 基座模型：huggingface.co/WisdomShell/CodeShell-7B代码助手 VSCode 插件：github.com/WisdomShell/codeshell-vscode具体来说，CodeShell-7B 基于 5000 亿 Tokens 进行了冷启动训练，上下文窗口长度为 8192。在权威的代码评估基准（HumanEval 和 MBPP）上，CodeShell 取得同等规模最好的性能，超过了 CodeLlama-7B 和 StarCodeBase-7B。与此同时，同 CodeShell-7B 配套的量化与本地部署方案，以及支持 VSCode 与 JetBrains IDE 的插件也全部开源，为新一代智能代码助手提供了轻量高效的全栈开源解决方案。CodeShell 模型和插件的相关代码已经在 Github 发布，并严格遵循 Apache 2.0 开源协议，模型在 HuggingFace 平台发布，支持商用。CodeShell：性能最强的 7B 代码基座大模型CodeShell 构建了高效的数据治理体系，通过冷启动预训练 5000 亿 Token，代码生成性能超过了 CodeLlama-7B 与 StarCoder-7B。相比而言，CodeLlama 在强大的 Llama2 上继续预训练依然学习了超过 5000 亿 Token，而 StarCoder 冷启动训练了 10000 亿 Token，是 CodeShell 的两倍 搞一个试试看//://:🐎出了北大有多强

Github: [github.com/WisdomShell/codeshellCodeShell](https://github.com/WisdomShell/codeshellCodeShell)
...
#### [ 《揭秘编码器与解码器语言模型》详情查看：Transformer 架构的问世标志着现代语言大模型时代 @开源中国](https://weibo.com/2194035935/NoAzoeTfn)

Note:  《揭秘编码器与解码器语言模型》详情查看：Transformer 架构的问世标志着现代语言大模型时代的开启。自 2018 年以来，各类语言大模型层出不穷。通过 LLM 进化树（github.com/Mooler0410/LLMsPracticalGuide）来看，这些语言模型主要分为三类：一是 “仅编码器”，该类语言模型擅长文本理解，因为它们允许信息在文本的两个方向上流动；二是 “仅解码器”，该类语言模型擅长文本生成，因为信息只能从文本的左侧向右侧流动，并以自回归方式有效生成新词汇；三 “编码器 - 解码器” 组，该类语言模型对上述两种模型进行了结合，用于完成需要理解输入并生成输出的任务，例如翻译。本文作者 Sebastian Raschka 对这三类语言模型的工作原理进行了详细解读。他是人工智能平台 Lightning AI 的 LLM 研究员，也是《Machine Learning Q and AI》的作者。全文查看：

Picture: [5375acf5gy1hj0n2eyucuj20u00nxalu.jpg](https://weibo.cn//mblog/pic/NoA9gtiih?rl=1)

Github: [github.com/Mooler0410/LLMsPracticalGuide](https://github.com/Mooler0410/LLMsPracticalGuide)
...
#### ['Baichuan2-Explained - Baichuan2代码的逐行解析版本，适合小白' Do @爱可可-爱生活](https://weibo.com/2194035935/No6G0BzHW)
...
#### [人手一个编程助手！北大最强代码大模型CodeShell-7B开源，性能霸榜，IDE插件全开源继 Co @PromptEngineer](https://weibo.com/1727858283/NoHHrcBar)

Note: 人手一个编程助手！北大最强代码大模型CodeShell-7B开源，性能霸榜，IDE插件全开源继 CodeLlama 开源之后，北大等机构正式开源了性能更强的代码基座大模型 CodeShell-7B 和代码助手 CodeShell-Chat。不仅如此，团队还把方便易用的 IDE 插件也开源了！今天，北京大学软件工程国家工程研究中心知识计算实验室联合四川天府银行 AI 实验室，正式开源 70 亿参数的代码大模型 CodeShell，成为同等规模最强代码基座。与此同时，团队将软件开发代码助手的完整解决方案全部开源，人手一个本地化轻量化的智能代码助手的时代已经来临！CodeShell 代码：github.com/WisdomShell/codeshellCodeShell 基座模型：huggingface.co/WisdomShell/CodeShell-7B代码助手 VSCode 插件：github.com/WisdomShell/codeshell-vscode具体来说，CodeShell-7B 基于 5000 亿 Tokens 进行了冷启动训练，上下文窗口长度为 8192。在权威的代码评估基准（HumanEval 和 MBPP）上，CodeShell 取得同等规模最好的性能，超过了 CodeLlama-7B 和 StarCodeBase-7B。与此同时，同 CodeShell-7B 配套的量化与本地部署方案，以及支持 VSCode 与 JetBrains IDE 的插件也全部开源，为新一代智能代码助手提供了轻量高效的全栈开源解决方案。CodeShell 模型和插件的相关代码已经在 Github 发布，并严格遵循 Apache 2.0 开源协议，模型在 HuggingFace 平台发布，支持商用。CodeShell：性能最强的 7B 代码基座大模型CodeShell 构建了高效的数据治理体系，通过冷启动预训练 5000 亿 Token，代码生成性能超过了 CodeLlama-7B 与 StarCoder-7B。相比而言，CodeLlama 在强大的 Llama2 上继续预训练依然学习了超过 5000 亿 Token，而 StarCoder 冷启动训练了 10000 亿 Token，是 CodeShell 的两倍 没用过，和 Copilo，比怎么样？//://:厉害了//:厉害了 //://:转发微博回复:[老师好]在AI领域，仿佛很少看到国外大学有模型，不知道是没有还是没消息啊啊啊，周末试试回复:绝对用的到，可以把想写的代码用文字描述一下，然后AI就帮你写完了刚开始学编程是不是用不到
...
#### [公开课《深度学习系统&人工智能系统》地址：github.com/chenzomi12/DeepLea @转发[159]](https://weibo.com/2194035935/NnN6OgFYF)

Note: 公开课《深度学习系统&人工智能系统》地址：github.com/chenzomi12/DeepLearningSystem这个开源项目英文名字叫做 Deep Learning System 或者 AI System(AISys)，中文名字叫做 深度学习系统 或者 AI系统。本开源项目主要是跟大家一起探讨和学习人工智能、深度学习的系统设计，而整个系统是围绕着 ZOMI 在工作当中所积累、梳理、构建 AI 系统全栈的内容。希望跟所有关注 AI 开源项目的好朋友一起探讨研究，共同促进学习讨论。 马克mark 马克

Picture: [82c654dfly1hiumlgxmclj21010tewqt.jpg](https://weibo.cn//mblog/pic/NnN6OgFYF?rl=1)
...
#### [【Text Embeddings Inference：超快接口方案，专注于文本嵌入模型的快速推断】' @#开源#](https://weibo.com/1402400261/NnPtejJFg)

Note: 【Text Embeddings Inference：超快接口方案，专注于文本嵌入模型的快速推断】'Text Embeddings Inference - A blazing fast inference solution for text embeddings models' Hugging Face GitHub: github.com/huggingface/text-embeddings-inference   

Picture: [5396ee05ly8hiux01pimvj21080u077s.jpg](https://weibo.cn//mblog/pic/NnPtejJFg?rl=1)

Github: [github.com/huggingface/text-embeddings-inference](https://github.com/huggingface/text-embeddings-inference)
...
#### [电子书《CLI text processing with GNU awk》使用 GNU awk 进行 @转发[52]](https://weibo.com/2194035935/NmVOmozeD)
...
#### [【LLaVA1.5：GPT-4-Vision的开源替代，提供多模态视觉-语言理解对话能力】- LLa @#机器学习#](https://weibo.com/1402400261/NmRo8l4db)

Note: 【LLaVA1.5：GPT-4-Vision的开源替代，提供多模态视觉-语言理解对话能力】- LLaVA是将视觉编码器和大语言模型Vicuna连接起来的端到端训练的大型多模态模型，用于通用的视觉和语言理解。   - 利用只用语言的GPT-4生成了多模态语言-图像指令遵循数据，包含对话、详细描述和复杂推理3类，共15.8万条。   - LLaVA在未见过的图片和指令上展现出强大的多模态聊天能力，在多模态指令遵循数据集上达到GPT-4的85.1%的相对分数。     - 提出两阶段的指令微调方法：先预训练投影矩阵，再端到端微调语言模型和投影矩阵。   “LLaVA: Large Language and Vision Assistant” Project: llava-vl.github.io Demo: llava.hliu.cc GitHub: github.com/haotian-liu/LLaVA 【LLaVA1.5：GPT-4-Vision的开源替代，提供多模态视觉-语言理解对话能力】 - LLaVA是将视觉编码器和大语言模型Vicuna连接起来的端到端训练的大型多模态模型，用于通用的视觉和语言理解。    Project: llava-vl.github.io Demo: llava.hliu.cc GitHub: github.com/haotian-liu/LLaVA   

Picture: [5396ee05ly8hinjgxqildj21al0u0q95.jpg](https://weibo.cn//mblog/pic/NmRo8l4db?rl=1)

Github: [github.com/haotian-liu/LLaVA](https://github.com/haotian-liu/LLaVA)

Github: [github.com/haotian-liu/LLaVA](https://github.com/haotian-liu/LLaVA)

#### [贾扬清在vLLM meetup分享了通过批处理和并行化提高大语言模型推理性能和降低成本。他展示了在单 @硅谷陈源博士](https://weibo.com/2194035935/NmQmJqhWT)

Note: 贾扬清在vLLM meetup分享了通过批处理和并行化提高大语言模型推理性能和降低成本。他展示了在单个英伟达A10上跑LLaMA-2 7B模型的结果。如果能够充分利用GPU资源，可以大大降低大模型的推理和应用成本。如果逐个处理单个请求，每秒可以产生大约40个tokens，但如果同时处理128个并发请求，每秒可以产生10个tokens，也足够满足人类平均的阅读速度要求（每秒5.5个单词）。这意味着单个A10每秒可以产生1700个tokens，通过额外的优化，可以达到每秒2500个tokens。这样，A10上每小时可以产生900万个tokens！他认为我们目前高估了大模型推理的成本。这些结果是基于vLLM，一个优化大模型推理的开源库，感兴趣的同学可以关注一下，github.com/vllm-project/vllm。

Picture: [007C1uJCgy1hin5fy5l6xj30zo0hhwig.jpg](https://weibo.cn//mblog/pic/NmO9esreQ?rl=1)
...
#### [《快乐的Linux 命令行》中英文对照版电子书地址：billie66.github.io/TLCL/ @蚁工厂](https://weibo.com/2194035935/Nmg4ntvv9)

Note: 《快乐的Linux 命令行》中英文对照版电子书地址：billie66.github.io/TLCL/book/这本书介绍如何生存在 Linux 命令行的世界。不像一些书籍仅仅涉及一个程序，比如像 shell 程序，bash。 本书着眼于更宏大的视角，试着向你传授如何与命令行界面友好相处。 它是怎样工作的？ 它能做什么？ 使用它的最好方法是什么？

Picture: [002otWYnly1guyejhjodpj60ko1ohgsy02.jpg](https://weibo.cn//mblog/pic/KB8AWc5cg?rl=1)

#### [电子书《Computer Graphics from Scratch》从零开始的计算机图形学动画电影 @蚁工厂](https://weibo.com/2194035935/Nm6VXsPnE)
...
#### [《从零开始的UEFI裸机编程》电子书地址：kagurazakakotori.github.io/ub @蚁工厂](https://weibo.com/2194035935/Nm0qSfDdF)

Note: 《从零开始的UEFI裸机编程》电子书地址：kagurazakakotori.github.io/ubmp-cn/本书是一份入门向的UEFI编程教程，大神 祐真 著, 神楽坂琴梨 译，介绍如何在不使用外部库和开发工具链，只使用UEFI API的情况下编写UEFI应用程序。由两部分组成：第一部分: 介绍UEFI的基本概念，如何阅读UEFI标准文档，并通过编写一个UEFI应用程序来介绍UEFI固件的常用功能。第二部分: 介绍更多的UEFI API，以及如何引导Linux回复:已收藏至你的notion[666]
...
#### [《Programming Rust - Fast, Safe Systems Development @转发[131]](https://weibo.com/2194035935/NlbKN8zN8)

Note: 《Programming Rust - Fast, Safe Systems Development》第2版的个人中文翻译地址：github.com/MeouSker77/ProgrammingRust如果你已经是一名系统程序员并且已经准备好替换C++，那么这本书就是为你而生。如果你是一名有其他任何语言的经验的开发者，不管是C#、Java、Python、JavaScript还是其他语言，这本书同样适用于你。回复:成功收藏到notion好勤奋，英文版刚看了一半

Picture: [82c654dfly1hiau97nstyj20ng1ev7ke.jpg](https://weibo.cn//mblog/pic/NlbKN8zN8?rl=1)
...
#### [Omnivore是一个完整的、开源的稍后阅读解决方案,面向喜欢文本的人。地址：github.com/ @转发[50]](https://weibo.com/2194035935/Nl3QE7RIa)

Note: Omnivore是一个完整的、开源的稍后阅读解决方案,面向喜欢文本的人。地址：github.com/omnivore-app/omnivore拥有iOS和Android客户端，以及各常见浏览器扩展 

Picture: [82c654dfly1hi9putb935j229g1le1kz.jpg](https://weibo.cn//mblog/pic/Nl3QE7RIa?rl=1)

Github: [github.com/omnivore-app/omnivore](https://github.com/omnivore-app/omnivore)

#### [Deep Learning Tuning Playbook，深度学习调优手册地址：github.co @转发[129]](https://weibo.com/2194035935/Nl2mk8agv)

Note: Deep Learning Tuning Playbook，深度学习调优手册地址：github.com/google-research/tuning_playbook一本用于系统地最大化深度学习模型性能的手册。“本文档适用于有兴趣最大化深度学习模型性能的工程师和研究人员(个人和团队)。我们假设他们已具备机器学习和深度学习的基础知识。我们强调的是超参数调优的过程。我们会涉及深度学习训练的其他方面,例如管道实现和优化,但我们对这些方面的处理并不打算做到全面完整。我们假设机器学习问题是一个监督学习问题,或者很像一个监督学习问题(例如自监督)。也就是说,本文档中的一些规定也可能适用于其他类型的问题。” 

Picture: [82c654dfly1hi9osiewsqj21et1hq4qp.jpg](https://weibo.cn//mblog/pic/Nl2mk8agv?rl=1)

Github: [github.com/google-research/tuning_playbook](https://github.com/google-research/tuning_playbook)
...
#### [阿里的大模型通义千问的开源版来了地址：github.com/QwenLM/Qwen-7B通义千问-7 @蚁工厂](https://weibo.com/2194035935/NkWdKj7Nk)

Note: 阿里的大模型通义千问的开源版来了地址：github.com/QwenLM/Qwen-7B通义千问-7B（Qwen-7B） 是阿里云研发的通义千问大模型系列的70亿参数规模的模型。Qwen-7B是基于Transformer的大语言模型, 在超大规模的预训练数据上进行训练得到。预训练数据类型多样，覆盖广泛，包括大量网络文本、专业书籍、代码等。同时，在Qwen-7B的基础上，使用对齐机制打造了基于大语言模型的AI助手Qwen-7B-Chat。//:官方又提供了纯C++实现。 可以在MacBook上跑了。地址：github.com/QwenLM/qwen.cpp

Picture: [82c654dfly1hgkdzqjzkej220e0wdgss.jpg](https://weibo.cn//mblog/pic/NcYuA1Mgy?rl=1)

Github: [github.com/QwenLM/Qwen-7B](https://github.com/QwenLM/Qwen-7B)

Github: [github.com/QwenLM/qwen.cpp](https://github.com/QwenLM/qwen.cpp)
...
#### [推荐 GitHub 上一个比较不错的中文大模型解决方案，代码完全开源，无商用限制。近日，Coloss @转发[497]](https://weibo.com/5722964389/NkXMMsPe4)

Note: 推荐 GitHub 上一个比较不错的中文大模型解决方案，代码完全开源，无商用限制。近日，Colossal-AI 团队充分利用了 LLaMA-2 的基础能力，采用高效的训练方法，仅使用约 8.5B token 数据、15 小时、数千元的训练成本，成功构建了性能卓越的中文 LLaMA-2，在多个评测榜单性能优越。相较于原始 LLaMA-2，在成功提升中文能力的基础上，进一步提升其英文能力，性能可与开源社区同规模预训练 SOTA 模型媲美。开源代码与权重：github.com/hpcaitech/ColossalAI该项目在 GitHub 完全开源了全套训练流程、代码及权重，无商用限制，并提供了一个完整的评估体系框架 ColossalEval，以实现低成本的可复现性。不仅如此，相关方案还可迁移应用到任意垂类领域，以及从头预训练大模型的低成本构建。感兴趣的同学可以试下。🐴 这里有漏网之鱼🐎🐴

Picture: [006fiYtfgy1hi8kx4cvwkj319t0vu4ho.jpg](https://weibo.cn//mblog/pic/NkXMMsPe4?rl=1)
...
#### [《Pragmatic Programmer》中文翻译地址：github.com/HabenChan/ @蚁工厂](https://weibo.com/2194035935/NkcCFtgqd)

Note: 《Pragmatic Programmer》中文翻译地址：github.com/HabenChan/pragmatic-programmer-zh程序员的务实主义哲学，英文版在项目里有链接 

Picture: [82c654dfly1h6cro8iu7oj20fr1kfask.jpg](https://weibo.cn//mblog/pic/M6AiE1nit?rl=1)

Github: [github.com/HabenChan/pragmatic-programmer-zh](https://github.com/HabenChan/pragmatic-programmer-zh)
