...
[contrastors](https://github.com/nomic-ai/contrastors): train and evaluate contrastive models efficiently

[Qwen1.5](https://github.com/QwenLM/Qwen1.5): 通义千问1.5模型

[A Survey on Transformer Compression](https://arxiv.org/abs/2402.05964): 华为transformer压缩综述, 剪枝,量化,蒸馏,NAS

[chinchilla](https://github.com/kyo-takano/chinchilla): 工具包,用来测算或评估scaling law

[nanodl](https://github.com/HMUNACHI/nanodl): transformer的JAX实现

[Interpretable Machine Learning](https://christophm.github.io/interpretable-ml-book/): 可解释的机器学习

[通往AGI之路](https://waytoagi.feishu.cn/wiki/QPe5w5g7UisbEkkow8XcDmOpn8e?continueFlag=dfef32ee7e6e88ed0e5fd659a6b1fb1f&mark_id=999_reallog_mark_ad%3A999%7CWeiboADNatural): AGI整理

[语言大模型的浮点运算分配](https://mp.weixin.qq.com/s/jgqs1eNiIOowK53IeB-k5A): 计算量分配

[ChatGPT_system_prompt](https://github.com/LouisShark/chatgpt_system_prompt): prompt整理