...
Github: [github.com/kyegomez/the-compiler](github.com/kyegomez/the-compiler)
...
Github: [github.com/OpenBMB/CPM-Bee](github.com/OpenBMB/CPM-Bee)
...
Github: [github.com/zjunlp/CaMA](github.com/zjunlp/CaMA)
...
Github: [github.com/OpenAccess-AI-Collective/axolotl](github.com/OpenAccess-AI-Collective/axolotl)
...
Github: [github.com/OpenBMB/ToolBench](github.com/OpenBMB/ToolBench)
...
Github: [github.com/RicherMans/SAT](github.com/RicherMans/SAT)
...
Github: [github.com/cherish-chat/xxim-server](github.com/cherish-chat/xxim-server)
...
Github: [github.com/dibrale/samist](github.com/dibrale/samist)
...
Github: [github.com/zakirullin/cognitive-load](github.com/zakirullin/cognitive-load)
...
Github: [github.com/jianzhnie/Chinese-Guanaco](github.com/jianzhnie/Chinese-Guanaco)
...
Github: [github.com/marl-book/fast-marl](github.com/marl-book/fast-marl)
...
Github: [github.com/liutiedong/goat](github.com/liutiedong/goat)
...
Github: [github.com/udlbook/udlbook/releases/download/v0.3.1/UnderstandingDeepLearning_15_12_22.pdf](github.com/udlbook/udlbook/releases/download/v0.3.1/UnderstandingDeepLearning_15_12_22.pdf)

#### [【LLaMA Efficient Tuning：用于大型语言模型的高效微调框架】'LLaMA Eff @爱可可-爱生活](https://weibo.com/1402400261/N30T1x1Fc)

Note: 【LLaMA Efficient Tuning：用于大型语言模型的高效微调框架】'LLaMA Efficient Tuning - Fine-tuning LLaMA with PEFT (PT+SFT+RLHF)' hoshi-hiyouga GitHub: github.com/hiyouga/LLaMA-Efficient-Tuning   

Picture: [5396ee05ly8hegndtqmsrj20rq0l2tb2.jpg](https://weibo.cn//mblog/pic/N30T1x1Fc?rl=1)

Github: [github.com/hiyouga/LLaMA-Efficient-Tuning](github.com/hiyouga/LLaMA-Efficient-Tuning)
...
Github: [github.com/OFA-Sys/ExpertLLaMA](github.com/OFA-Sys/ExpertLLaMA)
...
Github: [github.com/Chainlit/chainlit](github.com/Chainlit/chainlit)
...
Github: [github.com/Living-with-machines/genre-classification](github.com/Living-with-machines/genre-classification)
...
#### [电子书《机器学习系统：设计和实现》地址：openmlsys.github.io/index.html @蚁工厂](https://weibo.com/2194035935/N37B9w3DU)
...
Github: [github.com/intel/intel-one-mono](github.com/intel/intel-one-mono)
...
Github: [github.com/lyuchenyang/Macaw-LLMMacaw-LLM](github.com/lyuchenyang/Macaw-LLMMacaw-LLM)
...
#### [【Chinese-Guanaco: 中文低资源量化训练/部署方案，中文Guanaco(原驼)大语言模 @爱可可-爱生活](https://weibo.com/1402400261/N3jOmpxtr)
...
Github: [github.com/salesforce/CodeTF](github.com/salesforce/CodeTF)
...
Github: [github.com/dair-ai/ML-Papers-of-the-Week](github.com/dair-ai/ML-Papers-of-the-Week)
...
Github: [github.com/FurkanGozukara/Stable-Diffusion](github.com/FurkanGozukara/Stable-Diffusion)
...
Github: [github.com/satwikkansal/wtfpython](github.com/satwikkansal/wtfpython)
...
Github: [github.com/keyvank/femtoGPT](github.com/keyvank/femtoGPT)
...
Github: [github.com/SupaGruen/StableDiffusion-CheatSheet](github.com/SupaGruen/StableDiffusion-CheatSheet)
...
Github: [github.com/lifeiteng/vall-e](github.com/lifeiteng/vall-e)
...
Github: [github.com/Visualize-ML](github.com/Visualize-ML)
...
Github: [github.com/zjhellofss/KuiperInfer](github.com/zjhellofss/KuiperInfer)
...
Github: [github.com/chenzomi12/DeepLearningSystemDeep](github.com/chenzomi12/DeepLearningSystemDeep)
...
Github: [github.com/veekaybee/what_are_embeddings](github.com/veekaybee/what_are_embeddings)
...
Github: [github.com/datawhalechina/prompt-engineering-for-developers](github.com/datawhalechina/prompt-engineering-for-developers)
...
Github: [github.com/jart/blink](github.com/jart/blink)
...
Github: [github.com/lxgw/LxgwWenKai](github.com/lxgw/LxgwWenKai)
...
#### [EasySpider：一个在 GitHub 开源的可视化爬虫软件。使用图形化界面，无代码设计和执行爬 @GitHubDaily](https://weibo.com/5722964389/N1K0G2vP5)

Note: EasySpider：一个在 GitHub 开源的可视化爬虫软件。使用图形化界面，无代码设计和执行爬虫任务。开发者只需在网页上选择爬取内容，并根据提示框操作，即可完成爬虫设计和执行。GitHub：github.com/NaiboWang/EasySpider同时，软件还可以单独以命令行的方式进行执行，快速嵌入到其他系统中。 这老哥封装了一个类似八爪鱼的工具，数据量少，不要求速度，用这个还可以。转发微博作者在这里感谢分享~回复:作者在这里，必须要强调这个工具可以分布式并行多开的，数据量大速度也不是问题转发微博转发微博老师您好，方便加您联系方式沟通商务合作事宜吗？这不就是RPA 回复:666这么好?

Github: [github.com/NaiboWang/EasySpider](github.com/NaiboWang/EasySpider)
...
#### [59个深度学习论文的实现/教程，附带并排注释📝；包括变换器（原始的、xl、switch、feedba @蚁工厂](https://weibo.com/2194035935/N4brXF6wk)

Note: 59个深度学习论文的实现/教程，附带并排注释📝；包括变换器（原始的、xl、switch、feedback、vit等）、优化器（adam、adabelief等）、生成对抗网络（cyclegan、stylegan2等）、🎮强化学习（ppo、dqn）、capsnet、蒸馏等。地址：github.com/labmlai/annotated_deep_learning_paper_implementations 

Picture: [82c654dfly1hepdp51pcij21v61cqaqq.jpg](https://weibo.cn//mblog/pic/N4brXF6wk?rl=1)

Github: [github.com/labmlai/annotated_deep_learning_paper_implementations](github.com/labmlai/annotated_deep_learning_paper_implementations)
...
Github: [github.com/pentilm/FactAI](github.com/pentilm/FactAI)
...
Github: [github.com/nanochess/bootOS](github.com/nanochess/bootOS)
...
Github: [github.com/xinyu1205/Recognize_Anything-Tag2TextRAM](github.com/xinyu1205/Recognize_Anything-Tag2TextRAM)
...
Github: [github.com/axodox/axodox-machinelearning](github.com/axodox/axodox-machinelearning)
...
Github: [github.com/X-PLUG/Youku-mPLUG](github.com/X-PLUG/Youku-mPLUG)
...
Github: [github.com/PaddlePaddle/FlyCVFlyCV](github.com/PaddlePaddle/FlyCVFlyCV)

#### [计图大模型推理库 - 笔记本没有显卡也能跑大模型地址：github.com/Jittor/Jitto @蚁工厂](https://weibo.com/2194035935/N26rHfkeL)

Note: 计图大模型推理库 - 笔记本没有显卡也能跑大模型地址：github.com/Jittor/JittorLLMs本大模型推理库JittorLLMs有以下几个特点：1. 成本低：相比同类框架，本库可大幅降低硬件配置要求（减少80%），没有显卡，2G内存就能跑大模型，人人皆可在普通机器上，实现大模型本地部署；是目前已知的部署成本最低的大模型库；2. 支持广：目前支持了4种大模型：ChatGLM大模型；鹏程盘古大模型；BlinkDL的ChatRWKV；国外Meta的LLaMA大模型；后续还将支持MOSS等国内优秀的大模型，统一运行环境配置，降低大模型用户的使用门槛。3. 可移植：用户不需要修改任何代码，只需要安装Jittor版torch(JTorch)，即可实现模型的迁移，以便于适配各类异构计算设备和环境。4. 速度快：大模型加载速度慢，Jittor框架通过零拷贝技术，大模型加载开销降低40%，同时，通过元算子自动编译优化，计算性能相比同类框架提升20%以上。回复:成功保存至notion转发微博有这么十全十美的事？回头试试问题是可以跑哪个版本的llama 尊嘟假嘟

Picture: [82c654dfly1he9fjuvzmgj222z14chac.jpg](https://weibo.cn//mblog/pic/N26rHfkeL?rl=1)

Github: [github.com/Jittor/JittorLLMs](github.com/Jittor/JittorLLMs)

#### ['深度学习调优指南中文版 - 一本系统地教你将深度学习模型的性能最大化的战术手册。' schrodi @爱可可-爱生活](https://weibo.com/1402400261/N260l906I)

Note: '深度学习调优指南中文版 - 一本系统地教你将深度学习模型的性能最大化的战术手册。' schrodingercatss GitHub: github.com/schrodingercatss/tuning_playbook_zh_cn   这个好这个好

Picture: [5396ee05ly8he9o9xp5kaj20u00ynwir.jpg](https://weibo.cn//mblog/pic/N260l906I?rl=1)

Github: [github.com/schrodingercatss/tuning_playbook_zh_cn](github.com/schrodingercatss/tuning_playbook_zh_cn)
...
#### [Diffusers v0.17.0 正式发布，改进了 LoRA、Kandinsky 2.1、Torc @GitHubDaily](https://weibo.com/5722964389/N4uZGp1CF)

Note: Diffusers v0.17.0 正式发布，改进了 LoRA、Kandinsky 2.1、Torch 编译加速等特性。Diffusers 是一个预训练扩散模型的首选库，可用于生成图像、音频，甚至分子的 3D 结构。GitHub：github.com/huggingface/diffusers无论你是在寻找简单的推理解决方案还是训练自己的扩散模型，Diffusers 均可作为模块化工具箱提供支持。该库设计重在可用性与可定制性，主要提供以下 3 个核心组件：- 最先进的扩散管道，只需几行代码即可在推理中运行；- 可互换的噪声调度器，用于不同的扩散速度和输出质量；- 预训练模型可用作构建块，并与调度程序结合使用，用于创建自己的端到端扩散系统。转发微博

Picture: [006fiYtfgy1herxybrikxj316o0lcqv5.jpg](https://weibo.cn//mblog/pic/N4uZGp1CF?rl=1)

Github: [github.com/huggingface/diffusers](github.com/huggingface/diffusers)
...
Github: [github.com/SysCV/sam-hq](github.com/SysCV/sam-hq)

#### [redis7.0 中文注释地址：github.com/CN-annotation-team/redi @蚁工厂](https://weibo.com/2194035935/N4udbxLI1)

Note: redis7.0 中文注释地址：github.com/CN-annotation-team/redis7.0-chinese-annotated本项目灵感来源于《Redis设计与实现》作者黄健宏的redis3.0注释仓库：github.com/huangz1990/redis-3.0-annotated 回复:未收藏至notion，无公共集成 token回复:未能保存至Notion，无公共集成 token回复:未成功收藏至你的notion，无公共集成 token回复:成功保存到你的notion回复:成功收藏到Notion

Picture: [82c654dfly1herukzwq7jj21gy1iz4qp.jpg](https://weibo.cn//mblog/pic/N4udbxLI1?rl=1)

Github: [github.com/CN-annotation-team/redis7.0-chinese-annotated](github.com/CN-annotation-team/redis7.0-chinese-annotated)

Github: [github.com/huangz1990/redis-3.0-annotated](github.com/huangz1990/redis-3.0-annotated)
...
Github: [github.com/HuangOwen/Awesome-LLM-Compression](github.com/HuangOwen/Awesome-LLM-Compression)
...
Github: [github.com/FlagAI-Open/FlagAI/blob/master/examples/Aquila/README.mdAquila](github.com/FlagAI-Open/FlagAI/blob/master/examples/Aquila/README.mdAquila)
...
Github: [github.com/zetavg/LLaMA-LoRA-Tuner](github.com/zetavg/LLaMA-LoRA-Tuner)
...
Github: [github.com/yacineMTB/talk](github.com/yacineMTB/talk)
...
Github: [github.com/HandBrake/HandBrake](github.com/HandBrake/HandBrake)
...
#### [【关于 NLP】 那些你不知道的事地址：github.com/km1994/nlp_paper_st @蚁工厂](https://weibo.com/2194035935/N5mI8tj9k)

Note: 【关于 NLP】 那些你不知道的事地址：github.com/km1994/nlp_paper_study作者杨夕，该项目主要是作者在研读顶会论文和复现经典论文过程中，所见、所思、所想、所闻。两年多了，一直在坚持更新。 转发微博

Picture: [82c654dfly1h391t6ou1qj20u01dnalp.jpg](https://weibo.cn//mblog/pic/LxRWzEuh1?rl=1)

Github: [github.com/km1994/nlp_paper_study](github.com/km1994/nlp_paper_study)
...
#### [【baichuan-7B：一个开源可商用的大规模预训练语言模型。基于Transformer结构，在大 @爱可可-爱生活](https://weibo.com/1402400261/N5plN6XAU)

Note: 【baichuan-7B：一个开源可商用的大规模预训练语言模型。基于Transformer结构，在大约1.2万亿tokens上训练的70亿参数模型，支持中英双语，上下文窗口长度为4096】'baichuan-7B - A large-scale 7B pretraining language model developed by Baichuan' Baichuan Intelligent Technology GitHub: github.com/baichuan-inc/baichuan-7B  转发微博

Picture: [5396ee05ly8heyuth4ljdj235s0t80w3.jpg](https://weibo.cn//mblog/pic/N5plN6XAU?rl=1)

Github: [github.com/baichuan-inc/baichuan-7B](github.com/baichuan-inc/baichuan-7B)
...
Github: [github.com/undb-xyz/undb](github.com/undb-xyz/undb)
...
#### [baichuan-inc/baichuan-7B王小川的“百川智能”发布了7B参数的中英文LLM介绍 @宝玉xp](https://weibo.com/1727858283/N5w0obF24)

Note: baichuan-inc/baichuan-7B王小川的“百川智能”发布了7B参数的中英文LLM介绍baichuan-7B 是由百川智能开发的一个开源可商用的大规模预训练语言模型。基于 Transformer 结构，在大约1.2万亿 tokens 上训练的70亿参数模型，支持中英双语，上下文窗口长度为4096。在标准的中文和英文权威 benchmark（C-EVAL/MMLU）上均取得同尺寸最好的效果。github.com/baichuan-inc/baichuan-7B🔗转发微博Visualization方向提一嘴，后面两张柱状图不知是有意还是无意将baichuan和紫色的BLOOM（在多数组中表现垫底）放在一起并列，会“诱使”读者第一眼觉得黄色柱条显著高于其他结果很多（如果和浅蓝色并列这种错觉就弱很多）。回复:具备高质量的中文语料库，他也从未脱离技术一线。能开源可商用就是自信，另外这个7b选得很巧妙

Picture: [66fd066bgy1hezo7vosz3j21dq1z04qp.jpg](https://weibo.cn//mblog/pic/N5w0obF24?rl=1)
...
#### [技术博文《Myths Programmers Believe about CPU Caches》程序 @数据派THU](https://weibo.com/6004911042/N5sTIDYbx)
...
Github: [github.com/YJDoc2/8086-Emulator](github.com/YJDoc2/8086-Emulator)
...
Github: [github.com/sharkdp/hexyl](github.com/sharkdp/hexyl)
...
#### [李沐大佬的项目《深度学习论文精读》系列视频Github汇总：github.com/mli/paper @Maeiee](https://weibo.com/1240212845/N5HT0xpFK)

Note: 李沐大佬的项目《深度学习论文精读》系列视频Github汇总：github.com/mli/paper-reading视频也在B站和知乎更新。论文选取的原则是10年内深度学习里有影响力文章（必读文章），或者近期比较有意思的文章。 

Picture: [82c654dfly1gxd2tqf1vgj20u01bzq9z.jpg](https://weibo.cn//mblog/pic/L5Yai0Aar?rl=1)

Github: [github.com/mli/paper-reading](github.com/mli/paper-reading)
...
Github: [github.com/lyogavin/Anima](github.com/lyogavin/Anima)

#### ['fastllm - 纯c++的全平台llm加速库，无第三方依赖的大模型库，目前支持国产大模型Cha @爱可可-爱生活](https://weibo.com/1402400261/N5IGU406e)

Note: 'fastllm - 纯c++的全平台llm加速库，无第三方依赖的大模型库，目前支持国产大模型ChatGLM-6B，MOSS；chatglm-6B级模型单卡可达10000+token / s；可以在安卓设备上流畅运行ChatGLM-6B；可以在支持CUDA的设备上加速计算' ztxz16 GitHub: github.com/ztxz16/fastllm     

Picture: [5396ee05ly8hf186kbwwqj21060u078t.jpg](https://weibo.cn//mblog/pic/N5IGU406e?rl=1)

Github: [github.com/ztxz16/fastllm](github.com/ztxz16/fastllm)
...
#### [【Language Models：在512MB内存的计算机上探索大型语言模型，适合学习者和教育工作者 @爱可可-爱生活](https://weibo.com/1402400261/N5QWI5oGv)

Note: 【Language Models：在512MB内存的计算机上探索大型语言模型，适合学习者和教育工作者，无需API密钥，提供免费本地推断】’Language Models - Explore large language models on any computer with 512MB of RAM' Jon Craton GitHub: github.com/jncraton/languagemodels   

Picture: [5396ee05ly8hf28mpjec3j21bf0u0wk3.jpg](https://weibo.cn//mblog/pic/N5QWI5oGv?rl=1)

Github: [github.com/jncraton/languagemodels](github.com/jncraton/languagemodels)
...
#### [Hexyl：带有彩色输出的命令行十六进制查看器Hexyl 是一个简单的终端十六进制查看器。 它使用彩 @网路冷眼](https://weibo.com/1715118170/N5Kz6o1k9)

Note: Hexyl：带有彩色输出的命令行十六进制查看器Hexyl 是一个简单的终端十六进制查看器。 它使用彩色输出来区分不同类别的字节（NULL 字节、可打印的 ASCII 字符、ASCII 空白字符、其他 ASCII 字符和非 ASCII）。 源代码托管地址： 🔗 https:///github.com/sharkdp/hexyl 

Picture: [663aa05aly1hf1ggbwp7gj20b405kmx5.jpg](https://weibo.cn//mblog/pic/N5Kz6o1k9?rl=1)
...
Github: [github.com/Lesabotsy/bootcamp](github.com/Lesabotsy/bootcamp)
...
Github: [github.com/s0md3v/roop](github.com/s0md3v/roop)
...
#### [以ppt的形式来讲解LeetCode，地址：github.com/liweiwei1419/Leet @蚁工厂](https://weibo.com/2194035935/N6cTg8YFF)

Note: 以ppt的形式来讲解LeetCode，地址：github.com/liweiwei1419/LeetCode-Solution-PPT作者 liweiwei1419 给 LeetCode 中文版制作的题解 PPT。 真是掰开了揉碎了讲啊

Github: [github.com/liweiwei1419/LeetCode-Solution-PPT](github.com/liweiwei1419/LeetCode-Solution-PPT)

#### [【Deploy LLMs regardless of hardware system】https:/ @网路冷眼](https://weibo.com/1715118170/N6dJameg5)

Note: 【Deploy LLMs regardless of hardware system】https:///github.com/mlc-ai/mlc-llm MLC LLM 是一种通用解决方案，允许将任何语言模型本地部署在各种硬件后端和本地应用程序上，此外还有一个高效的框架，供每个人进一步优化自己用例的模型性能。 

Github: [github.com/mlc-ai/mlc-llm](github.com/mlc-ai/mlc-llm)

#### [【vLLM：易于使用、快速且廉价的LLM服务库，比HuggingFace Transformers  @爱可可-爱生活](https://weibo.com/1402400261/N6i8b2DZO)

Note: 【vLLM：易于使用、快速且廉价的LLM服务库，比HuggingFace Transformers (HF)的吞吐量高出最多24倍，比Text Generation Inference (TGI)高出最多3.5倍，具有出色的推理吞吐量、对注意力键和值内存的高效管理、动态批处理、优化的CUDA内核等特点，与流行的HuggingFace模型无缝集成，支持高吞吐量的服务和各种解码算法，并提供Tensor并行支持和流式输出，支持多种HuggingFace模型，包括GPT-2、GPTNeoX、LLaMA和OPT】”vLLM: Easy, Fast, and Cheap LLM Serving with PagedAttention”  GitHub: github.com/vllm-project/vllm 转发微博

Picture: [5396ee05ly8hf5kluf3z1j21020u0ae7.jpg](https://weibo.cn//mblog/pic/N6i8b2DZO?rl=1)

Github: [github.com/vllm-project/vllm](github.com/vllm-project/vllm)

#### [vllm，一个用于LLMs的高吞吐量和内存效率的推理和服务引擎地址：github.com/vllm- @蚁工厂](https://weibo.com/2194035935/N6i1meVYa)

Note: vllm，一个用于LLMs的高吞吐量和内存效率的推理和服务引擎地址：github.com/vllm-project/vllm项目介绍：“LLMs承诺将从根本上改变我们在所有行业中使用AI的方式。然而，实际上运行这些模型是具有挑战性的，甚至在昂贵的硬件上也可能出奇地慢。今天我们很高兴介绍vLLM，这是一个用于快速LLM推理和服务的开源库。vLLM利用了我们的新注意力算法PagedAttention，有效地管理注意力键和值。配备了PagedAttention的vLLM重新定义了LLM服务的新艺术状态：它提供的吞吐量高达HuggingFace Transformers的24倍，而无需进行任何模型架构的改变。”

Picture: [82c654dfly1hf5k6s2b3mj20m909mt98.jpg](https://weibo.cn//mblog/pic/N6i1meVYa?rl=1)
...
Github: [github.com/jackaduma/Vicuna-LoRA-RLHF-PyTorch](github.com/jackaduma/Vicuna-LoRA-RLHF-PyTorch)
...
Github: [github.com/kaist-silab/rl4co](github.com/kaist-silab/rl4co)
...
Github: [github.com/zilliztech/VectorDBBench](github.com/zilliztech/VectorDBBench)
...
Github: [github.com/nuance1979/llama-server](github.com/nuance1979/llama-server)
...
#### [电子书《Elements of Programming》这本老书在出版十年后推出了免费pdf版。 中 @蚁工厂](https://weibo.com/2194035935/N6Y15Fow8)

Note: 电子书《Elements of Programming》这本老书在出版十年后推出了免费pdf版。 中文翻译版叫编程原本追溯数学原理，探求编程的本质，一窥STL的设计思想，体会程序设计的迭代式过程，发现处理问题的算法 收藏回复:已收藏到你的notion免费的是英文的，中文的还是要付费 STL之父的作品
...
Github: [github.com/facebookincubator/dynolog](github.com/facebookincubator/dynolog)
...
Github: [github.com/ntunlp/xCodeEval](github.com/ntunlp/xCodeEval)
...
Github: [github.com/XingangPan/DragGANHuggingface](github.com/XingangPan/DragGANHuggingface)
...
Github: [github.com/dzhng/zod-gpt](github.com/dzhng/zod-gpt)
...
#### [计算机网络图解系列（英文）包含开发人员的计算机网络基础知识、Linux iptables 图解、SS @蚁工厂](https://weibo.com/2194035935/N7gqTiQUb)

Note: 计算机网络图解系列（英文）包含开发人员的计算机网络基础知识、Linux iptables 图解、SSH 隧道可视化指南等多篇博文。特点是有大量手工绘图。 回复:已收藏到你的Notion回复:已收藏至Notion👍回复:已收藏到你的notion
...
Github: [github.com/easychen/deepgpt-dist](github.com/easychen/deepgpt-dist)

Github: [github.com/easychen/deepgpt-dist/blob/master/build.zip](github.com/easychen/deepgpt-dist/blob/master/build.zip)
...
Github: [github.com/phodal/aigc](github.com/phodal/aigc)

#### [Patterns of Distributed Systems，分布式系统的模式分布式系统的编程提供 @蚁工厂](https://weibo.com/2194035935/N7lThsdfO)

Note: Patterns of Distributed Systems，分布式系统的模式分布式系统的编程提供了特殊的挑战。它们通常需要我们有多份数据副本，这些副本需要保持同步。然而，我们不能依赖处理节点的可靠工作，网络延迟很容易导致不一致性。尽管如此，许多组织依赖于一系列核心的分布式软件来处理数据存储、消息传递、系统管理和计算能力。这些系统面临着共同的问题，他们用类似的解决方案来解决。本文识别并发展了这些解决方案作为模式，通过这些模式，我们可以建立对如何更好地理解、交流和教授分布式系统设计的理解。回复:已收藏到你的notion[666]
...
Github: [github.com/abacaj/replit-3B-inference](github.com/abacaj/replit-3B-inference)
...
Github: [github.com/ahmetbersoz/chatgpt-prompts-for-academic-writing](github.com/ahmetbersoz/chatgpt-prompts-for-academic-writing)
...
Github: [github.com/commaai/commavq](github.com/commaai/commavq)
...
#### [电子书《The Linux Networking Architecture: Design and  @蚁工厂](https://weibo.com/2194035935/N7zdvlOO3)

Note: 电子书《The Linux Networking Architecture: Design and Implementation of Network Protocols in the Linux Kernel 》pdf下载：本书旨在为给予和专业人士提供在Linux内核中实现网络功能所需的基础知识，同时也针对希望加深对操作系统中特定于网络的进程的理解的每个人。 本书介绍了Linux内核的关键组件和机制以及通信系统的设计。这本由专家编写的独特的Linux网络教程/参考为读者提供了一个实用的概述，并了解了Linux内核中网络协议的实现。 本书展示了如何在Linux操作系统中实现网络行为和协议。 这本书提供了Linux内核的介绍，主要集中在即将到来的内核版本2. 4，但也适用于版本2. 2内核。本书的结构遵循TCP/IP分层模型，从内核的网络设备驱动程序开始，继续到链路层协议（如PPP），最后给出TCP/IP协议族的所有核心协议的描述。 还包括其他补充协议，如RSVP、IP安全和移动的IP。英文版，以上内容机翻~Linux network的书太少了，这本也比较旧了
...
#### [最近的很多开源模型都在基于GPT-4的数据做调优。微软表示你们这些模型学GPT都学的太浅了，徒有其表 @蚁工厂](https://weibo.com/2194035935/N7ELNr0mt)

Note: 最近的很多开源模型都在基于GPT-4的数据做调优。微软表示你们这些模型学GPT都学的太浅了，徒有其表。看我们搞个深层次的，不但要模仿GPT-4 的风格，还要学习其推理过程等等。微软刚发布了Orca的论文，这是一个130亿参数的模型，它学会模仿LFM的推理过程。Orca从GPT-4的丰富信号中学习，包括解释追踪；逐步的思考过程；以及其他复杂的指令。论文下载：aka.ms/orca-lm其能力在一些之前开源模型不擅长的评测（如考试或复杂推理）中效果已经接近了ChatGPT，较大幅度的超出其他的开源模型。

Picture: [82c654dfly1hewch43b1jj20oc0h6q89.jpg](https://weibo.cn//mblog/pic/N5693EoXE?rl=1)

#### [最近的很多开源模型都在基于GPT-4的数据做调优。微软表示你们这些模型学GPT都学的太浅了，徒有其表 @梁斌penny](https://weibo.com/1497035431/N7FhXs2UJ)

Note: 最近的很多开源模型都在基于GPT-4的数据做调优。微软表示你们这些模型学GPT都学的太浅了，徒有其表。看我们搞个深层次的，不但要模仿GPT-4 的风格，还要学习其推理过程等等。微软刚发布了Orca的论文，这是一个130亿参数的模型，它学会模仿LFM的推理过程。Orca从GPT-4的丰富信号中学习，包括解释追踪；逐步的思考过程；以及其他复杂的指令。论文下载：aka.ms/orca-lm其能力在一些之前开源模型不擅长的评测（如考试或复杂推理）中效果已经接近了ChatGPT，较大幅度的超出其他的开源模型。//:我猜，我们这边也会很快有开源数据集的，努力吧。//:因为看上去微软不打算开源了，工程师Eric Hartford准备基于其论文搞个开源版本OpenOrca  目前已经发布了基于GPT4/3.5的数据集 请问梁博对目前 LLM 的发展有什么看法？我们的工程师们为什么没有这种意识？难道就只会复制粘贴？只是弱弱问一句~
...
Github: [github.com/peiyuanix/yuanix-riscv-os](github.com/peiyuanix/yuanix-riscv-os)

#### [MPT-30B这个大模型的特点是低训练成本和运行成本。这个项目（ github.com/abacaj @蚁工厂](https://weibo.com/2194035935/N7Ovfuukv)

Note: MPT-30B这个大模型的特点是低训练成本和运行成本。这个项目（ github.com/abacaj/mpt-30B-inference ）让你可以使用CPU在MPT-30B模型上运行推理。运行需要32G内存。视频为运行效果。推出MPT-30B模型的MosaicML公司刚被Databricks以13亿美元收购。  回复:已保存至你的notion转发微博难得

Github: [github.com/abacaj/mpt-30B-inference](github.com/abacaj/mpt-30B-inference)

#### [系列电子书《鸢尾花书：从加减乘除到机器学习》，包含“编程不难”“可视之美”“数学要素”“矩阵力量”“ @蚁工厂](https://weibo.com/2194035935/N7ODlvPFs)

Note: 系列电子书《鸢尾花书：从加减乘除到机器学习》，包含“编程不难”“可视之美”“数学要素”“矩阵力量”“统计至简”“数据有道”“机器学习”七本电子书地址：github.com/Visualize-ML作者生姜DrGinger。本库是书籍的开源版。其中“数学要素”“矩阵力量”已经正式出版： //:《可视之美》已发布初版： github.com/Visualize-ML/Book2_Beauty-of-Data-Visualization

Picture: [82c654dfly1hen1r1xj2sj21o50ul1hr.jpg](https://weibo.cn//mblog/pic/N3R82hK4e?rl=1)

Github: [github.com/Visualize-ML](github.com/Visualize-ML)

Github: [github.com/Visualize-ML/Book2_Beauty-of-Data-Visualization](github.com/Visualize-ML/Book2_Beauty-of-Data-Visualization)
...
Github: [github.com/leaningtech/webvmwebvm](github.com/leaningtech/webvmwebvm)

#### [最近的很多开源模型都在基于GPT-4的数据做调优。微软表示你们这些模型学GPT都学的太浅了，徒有其表 @宝玉xp](https://weibo.com/1727858283/N7NO9Faxp)

Note: 最近的很多开源模型都在基于GPT-4的数据做调优。微软表示你们这些模型学GPT都学的太浅了，徒有其表。看我们搞个深层次的，不但要模仿GPT-4 的风格，还要学习其推理过程等等。微软刚发布了Orca的论文，这是一个130亿参数的模型，它学会模仿LFM的推理过程。Orca从GPT-4的丰富信号中学习，包括解释追踪；逐步的思考过程；以及其他复杂的指令。论文下载：aka.ms/orca-lm其能力在一些之前开源模型不擅长的评测（如考试或复杂推理）中效果已经接近了ChatGPT，较大幅度的超出其他的开源模型。部署一次，拿到针对秸秆处理或某类生活垃圾的处理方案，就可终生退网——这才是我心目中的人工智能，就是不知道这个思路能不能行！ 
...
Github: [github.com/davidar/eigenGPT](github.com/davidar/eigenGPT)

#### [王树森老师（深度强化学习一书的作者）的公开课《高级算法》地址：github.com/wangshus @Maeiee](https://weibo.com/1240212845/N88v9eFJE)

Note: 王树森老师（深度强化学习一书的作者）的公开课《高级算法》地址：github.com/wangshusen/AdvancedAlgorithms该库包括PPT和视频链接。另外在B站ShusenWang频道也有部分视频 

Picture: [82c654dfly1hfjhhuc18mj218s14ktsu.jpg](https://weibo.cn//mblog/pic/N88uOuaQ6?rl=1)

Github: [github.com/wangshusen/AdvancedAlgorithms](github.com/wangshusen/AdvancedAlgorithms)
...
#### [ 周末重装了一下macOS，所以有了这份儿 “Mac 开光指南（V3）”。主要对新入手macOS之后 @蚁工厂](https://weibo.com/2194035935/N871XwfKA)

Note:  周末重装了一下macOS，所以有了这份儿 “Mac 开光指南（V3）”。主要对新入手macOS之后，安全研究/从业人员应该安装的基础软件，或者需要配置的开发环境，进行了记录和说明。具体的目录如图1所示。大家有相同需要的可以看一下，如果有其他想要咨询的也可以在评论区评论。PS：这份指南是基于 shockerli 的“Mac 开光指南（V2）”进行二创而来有没有win版呢
...
Github: [github.com/zhaoyun0071/DragGAN-Windows-GUIDragGAN](github.com/zhaoyun0071/DragGAN-Windows-GUIDragGAN)
...
Github: [github.com/beyondguo/LLM-Tuning](github.com/beyondguo/LLM-Tuning)
...
Github: [github.com/johnlui/DIY-Search-Engine](github.com/johnlui/DIY-Search-Engine)
...
Github: [github.com/ixahmedxi/noodle](github.com/ixahmedxi/noodle)
...
Github: [github.com/SpongebBob/Finetune-ChatGLM2-6B](github.com/SpongebBob/Finetune-ChatGLM2-6B)
...
Github: [github.com/AnicetNgrt/jiro-nn](github.com/AnicetNgrt/jiro-nn)
...
#### [技术博客《卡瓦邦噶！》这里是一个 SRE 的博客，讨论的内容有：Linux, Vim, Tmux,  @蚁工厂](https://weibo.com/2194035935/N8KaM5VbB)

Note: 技术博客《卡瓦邦噶！》这里是一个 SRE 的博客，讨论的内容有：Linux, Vim, Tmux, NixOS, Python, Java, TCP/IP, Container, Docker, Ansible, Git, Graphviz, Redis, Prometheus, SSH, Shell, Bash, GNU, Github, C, C++, Unix, Nginx, Lua, Django, React 以及运维的方法论，编程的思考，工作的感悟。作者也是播客《捕蛇者说》的大佬之一。回复:成功收藏至notion[开学季]回复:已保存到Notion转发微博卡老师博客挺赞

Picture: [82c654dfly1hfo2fg76wzj20x61b01ir.jpg](https://weibo.cn//mblog/pic/N8KaM5VbB?rl=1)

#### [fastllm是纯c++实现，无第三方依赖的高性能大模型推理库。6~7B级模型在安卓端上也可以流畅运 @蚁工厂](https://weibo.com/2194035935/N8IMIAYQo)

Note: fastllm是纯c++实现，无第三方依赖的高性能大模型推理库。6~7B级模型在安卓端上也可以流畅运行地址：github.com/ztxz16/fastllm支持python调用，chatglm-6B级模型单卡可达10000+token / s，支持glm, llmam, moss基座，手机端流畅运行 牛的回复:已收藏至notion帅气

Picture: [82c654dfly1hfo1b3t02tj21n80q07hh.jpg](https://weibo.cn//mblog/pic/N8IMIAYQo?rl=1)
...
Github: [github.com/InternLM/lmdeploy](github.com/InternLM/lmdeploy)
...
Github: [github.com/crlandsc/tiny-audio-diffusion](github.com/crlandsc/tiny-audio-diffusion)
...
Github: [github.com/MLGroupJLU/LLM-eval-survey](github.com/MLGroupJLU/LLM-eval-survey)
...
Github: [github.com/havenhq/haven](github.com/havenhq/haven)

#### [推荐阅读：《AI Agents大爆发：软件2.0雏形初现，OpenAI的下一步》这篇文章的原作者是L @宝玉xp](https://weibo.com/1727858283/N8It4C6ib)

Note: 推荐阅读：《AI Agents大爆发：软件2.0雏形初现，OpenAI的下一步》这篇文章的原作者是Lilian Weng，她现在是 OpenAI 的 Head of Safety Systems，之前还领导过 OpenAI 的 Applied AI 团队。Lilian Weng 的这篇 Blog 可以说是目前 AI Agent 领域优质论文的系统综述，她将 Agents 定义为 LLM、记忆（Memory）、任务规划（Planning Skills）以及工具使用（Tool Use） 的集合，其中 LLM 是核心大脑，Memory、Planning Skills 以及 Tool Use 等则是 Agents 系统实现的三个关键组件，在文章中，她还对每个模块下实现路径进行了细致的梳理和说明。到今天，构建 AI Agent 的工具箱已经相对完善，但仍需要面对一些限制，例如上下文长度、长期规划和任务分解，以及 LLM 能力的稳定性等。英文原文：lilianweng.github.io/posts/2023-06-23-agent/🔗完整中文翻译 by 拾象 海外独角兽：

Picture: [66fd066bly8hflz5rd6amj21jj0m1mzn.jpg](https://weibo.cn//mblog/pic/N8rTC7OJZ?rl=1)

#### [fastllm是纯c++实现，无第三方依赖的高性能大模型推理库。6~7B级模型在安卓端上也可以流畅运 @Maeiee](https://weibo.com/1240212845/N8JigtS4p)

Note: fastllm是纯c++实现，无第三方依赖的高性能大模型推理库。6~7B级模型在安卓端上也可以流畅运行地址：github.com/ztxz16/fastllm支持python调用，chatglm-6B级模型单卡可达10000+token / s，支持glm, llmam, moss基座，手机端流畅运行 
...
Github: [github.com/kenjihiranabe/The-Art-of-Linear-Algebra](github.com/kenjihiranabe/The-Art-of-Linear-Algebra)

#### [【方便的封装器，用于在内存受限环境中进行大型语言模型(LLM)的微调和推理，支持参数高效微调(例如L @Maeiee](https://weibo.com/1240212845/N95qGnmxe)
